    ...
    <div className="flex-1 flex flex-col max-w-6xl mx-auto w-full py-4 space-y-8 overflow-hidden">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="h-[1px] flex-grow mx-6 bg-outline-variant/10"></div>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {[
            ...
            <div key={tech.name} className="neumorphic-elevated bg-surface-container-high p-4 rounded-xl text-center group border border-white/5">
      ...
      {/* Footer */}
      <footer className="mt-auto py-4 border-t border-white/5 flex items-center justify-between gap-8">
